...
data class Message(
    ...
    @get:PropertyName("receiverID") @set:PropertyName("receiverrID") var receiverID: String = "",
    ...
    @get:PropertyName("lowQualityThumbnail") @set:PropertyName("lowQualityThumbnail") var lowQualityThumbnail: String = "",
