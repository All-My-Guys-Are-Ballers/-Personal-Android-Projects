...
import com.example.githubsearchengine.network.ApiInterface
import com.example.githubsearchengine.utils.Constants.SERVER_ENDPOINT
        ...
        private fun getRetrofit(): Retrofit {
            return retrofit ?: synchronized(this) {
                ...
                retrofit = Retrofit.Builder()
                    ...
                    .baseUrl(SyncStateContract.Constants.SERVER_ENDPOINT + "/")
                    .build()
