package com.example.mp35ptest.action;
...
import com.example.mp35ptest.MainActivity;
import com.example.mp35ptest.core.AAction;
import com.example.mp35ptest.core.ActionResult;
import com.example.mp35ptest.emv.EmvTags;
import com.example.mp35ptest.emv.EmvTransProcessImpl;
import com.example.mp35ptest.entity.TransData;
import com.example.mp35ptest.param.AidParam;
import com.example.mp35ptest.param.CapkParam;
    ...
    protected void process() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                aidParam.init(MyApplication.mApp);
                emv.setAidList(aidParam.saveEmvAidParam());
                CapkParam capkParam = new CapkParam();
                capkParam.init(MyApplication.mApp);
                emv.setCapkList(capkParam.saveEmvCapkParam());
