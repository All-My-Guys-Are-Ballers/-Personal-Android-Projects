package com.example.mp35ptest.emv;
...
import com.example.mp35ptest.action.ActionEnterPin;
...
import com.example.mp35ptest.entity.TransResult;
import com.example.mp35ptest.transmit.Online;
...
public class EmvTransProcessImpl extends ETransProcessListenerImpl {
    ...
    private AidlPinpad mPinpad = usdkManage.getPinpad(0);
