package com.example.charts.renderer
...
class NxYAxisDrawer(
    ...
    override fun drawAxisLabels(
        ...
        for (i in 0..labelCount) {
            val value = Math.abs(minValue + (i * ((maxValue - minValue) / labelCount)))
            ...
            val y =
                drawableArea.bottom - (i * (totalHeight / labelCount)) + (textBounds.height() / 2f) - 8f
